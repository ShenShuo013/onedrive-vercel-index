...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'qianqiuadmin@0rw23.onmicrosoft.com',
  ...
  title: "qianqiu's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/Netflav',
  ...
  protectedRoutes: ['/Netflav', '/🥟 Some test files/Protected route'],
